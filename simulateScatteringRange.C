/*
*	This ROOT macro performs simulations at within an angular range. The minimum and the maximum 
*	value of the angles is read from MINIMUM_DETECTOR_ANGLE and MAXIMUM_DETECTOR_ANGLE ( defined in constants.C ). 
*	The results of the simulation are saved in a file. The location of the file is read from the variable
...
*/
void simulateScatteringRange(double incidentElectronEnergy, long count){
